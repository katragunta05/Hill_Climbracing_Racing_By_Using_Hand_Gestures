...
# Capturing the Video from the Cameraven
...
while True:
    ...
    if results.multi_hand_landmarks != None:
        ...
        # If All Fingers Open --> Gas
            ...
            cv.putText(image, "5", (45, 375), cv.FONT_HERSHEY_SIMPLEX, 2, (255, 0, 0), 5)
    ...
    if cv.waitKey(1) & 0xFF == ord('q'):
        break
video.release()
cv.destroyAllWindows()  # run command is : python climb.py